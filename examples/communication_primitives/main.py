...
def main():
    ...
    in_splits = [8, 8] # [2, 2, 2, 2, 2, 2, 2, 2]
    out_splits = [8, 8] # [2, 2, 2, 2, 2, 2, 2, 2]
    send_counts = [8, 8] # [2, 2, 2, 2, 2, 2, 2, 2]
    recv_counts = [8, 8] # [2, 2, 2, 2, 2, 2, 2, 2]
    send_sdispls = [0, 8] # [0, 2, 4, 6, 8, 10, 12, 14, 16]
    recv_sdispls = [0, 8] # [0, 2, 4, 6, 8, 10, 12, 14, 16]
